...
import { 
  Target, Heart, Briefcase, DollarSign, Sparkles, Calendar,
  BookOpen, Users, TrendingUp, Bell, Settings, Plus, LogOut
} from 'lucide-react'
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {userAge} anos • Recomendações personalizadas para você
          </p>
        </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4">
                <p className="text-sm">Desenvolva habilidades profissionais relevantes</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4">
                <p className="text-sm">Cuide da sua saúde física e mental</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4">
                <p className="text-sm">Construa relacionamentos significativos</p>
              </div>
            </div>
          </CardContent>
        </Card>
